...
function ProductGridLoading({ items }: { items: number }) {
  return (
    <div className="grid grid-cols-1 gap-6 px-4 py-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-items-center">
      {Array(items)
        .fill(0)
        .map((_, i) => (
          <div
